...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <th scope="row">실제 매출액</th>
            <th scope="row">돈통</th>
            <th scope="row">(현금 매출액 - 시재금) + 카드 매출액</th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" id="RevenueInputForm">
                        <div class="mb-3">
                            <label for="cashRevenue" class="col-form-label">현금 매출액 : </label>
                            <input type="text" class="form-control" id="cashRevenue">
                        </div>
                        <div class="mb-3">
                            <label for="cardRevenue" class="col-form-label">카드 매출액 : </label>
                            <input type="text" class="form-control" id="cardRevenue">
                        </div>
                        <div class="mb-3">
                            <label for="vaultCash" class="col-form-label">시재금 : </label>
                            <input type="text" class="form-control" id="vaultCash">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">취소</button>
                    <button type="submit" class="btn btn-primary" form="RevenueInputForm">정산 입력</button>
                </div>
            </div>
        </div>
    </div>
