...
<body>
<my:navBar current="addEvent"></my:navBar>


<div class="container-lg">
    <div style="margin: 50px 200px 300px 200px; border: 8px double gray;">
        <form class="ui form" style="margin: 30px 100px 60px 100px" method="post" id="addEventForm">
            </br>
            <input type="hidden" name="checkEvent" value="${book.checkEvent}">
<h1 class="ui dividing header" style="text-align:center;"> '${book.title}'의 이벤트 등록</h1>
    </br>
            ...
            <h4 class="ui header">이벤트 상세내용</h4>
            <div class="field">

                <textarea name="event" value="${book.event }" rows="10" placeholder="이벤트 상세내용을 적어주세요"></textarea>
            </div>
        ...
        <div>
        <button type="submit" class="btn btn-outline-primary" form="addEventForm">등록</button>
        </div>
